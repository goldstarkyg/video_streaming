...
class AdminPluginsController extends Controller {
	...
	public function activate($slug){
		...
		return redirect('admin/plugins')->with(array('note' => 'Successfully Activated ' . $plugin_data['name'], 'note_type' => 'success'));
	}
	...
	public function deactivate($slug){
		...
		$plugin->active = 0;
		$plugin->save();
		return redirect('admin/plugins')->with(array('note' => 'Successfully De-activated ' . $plugin_data['name'], 'note_type' => 'success'));
	}
