...
class Kernel extends HttpKernel
{
    ...
    protected $middlewareGroups = [
        'web' => [
            ...
            \HelloVideo\Http\Middleware\ConcurrentLogins::class,
    ...
    protected $routeMiddleware = [
        ...
        'Subscribed' => \HelloVideo\Http\Middleware\Subscribed::class,
        'demo' => \HelloVideo\Http\Middleware\demo::class,
        'auth.comments' => \Illuminate\Auth\Middleware\Authenticate::class
    ];
}
