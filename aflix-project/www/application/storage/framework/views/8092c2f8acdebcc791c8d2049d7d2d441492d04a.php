...
?>
	<div class="admin-section-title">
		<div class="row">
			<div class="col-md-8">
				<h3><i class="entypo-user"></i> Manage Payment For Subscribe Video</h3><!--<a href="<?php echo e(URL::to('admin/user/create')); ?>" class="btn btn-success"><i class="fa fa-plus-circle"></i> Add New</a>-->
			</div>
			<div class="col-md-4">
