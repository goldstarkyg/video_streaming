								...
								<div class="panel panel-primary" data-collapsed="0">
									...
									<div class="panel-body" style="display: block;">
										...
										<select  class="form-control" id="contribute" name="contribute">
											<option value="" <?php if(isset($user->corporate_user) && $user->corporate_user == ''): ?>selected="selected"<?php endif; ?>>No Contribute User</option>
											<option value="contribute" <?php if(isset($user->corporate_user) && $user->corporate_user == 'Corporate_User'): ?>selected="selected"<?php endif; ?>>Contribute User</option>
										</select>
									</div>
								</div>
							</div>
