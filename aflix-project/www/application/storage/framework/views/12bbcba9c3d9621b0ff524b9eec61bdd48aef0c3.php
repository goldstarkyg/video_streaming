...
?>
	<div class="admin-section-title">
		<div class="row">
			<div class="col-md-8">
				<h3><i class="entypo-user"></i>Corporate User</h3><!--<a href="<?php echo e(URL::to('admin/user/create')); ?>" class="btn btn-success"><i class="fa fa-plus-circle"></i> Add New</a>-->
			</div>
			<div class="col-md-4">
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
				...
				<td>
					...
					<a href="<?php echo e(URL::to('admin/user/edit2') . '/' . $user->id); ?>" class="btn btn-xs btn-info"><span class="fa fa-edit"></span> View / Edit</a>

					<?php if( ($user->status == '1')): ?>
					<a href="<?php echo e(URL::to('admin/user/editstatus3') . '/' . $user->id); ?>" class="btn btn-xs btn-danger delete1"><span class="fa fa-user"></span> Block</a>
					<?php elseif( ($user->status == '0') ): ?>
					<a href="<?php echo e(URL::to('admin/user/editstatus2') . '/' . $user->id); ?>" class="label label-success delete"><span class="fa fa-user"></span> Active</a>
					<?php endif; ?>
				</td>
			</tr>
			<?php
