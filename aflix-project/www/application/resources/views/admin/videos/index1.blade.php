...
@section('content')
	...
	<div class="admin-section-title">
		<div class="row">
			<div class="col-md-8">
				<h3><i class="entypo-video"></i> Videos</h3><a href="{{ URL::to('admin/videos/create1') }}" class="btn btn-success"><i class="fa fa-plus-circle"></i> Add New</a>
			</div>
			<div class="col-md-4">	
			...
			<div class="col-sm-6 col-md-4">
				...
				<article class="album">
					...
					<header>
						...
						<a href="{{ URL::to('admin/videos/edit1') . '/' . $video->id }}" class="album-options">
					...
					<section class="album-info">
						<h3><a href="{{ URL::to('admin/videos/edit1') . '/' . $video->id }}"><?php if(strlen($video->title) > 25){ echo substr($video->title, 0, 25) . '...'; } else { echo $video->title; } ?></a></h3>
					...
					<footer>
						...
						<div class="album-options">
							<a href="{{ URL::to('admin/videos/edit1') . '/' . $video->id }}">
								<i class="entypo-pencil"></i>
							</a>
