...
?>
    ...
    zoom: 1;">Upload Video</button>
					...
					<div class="ew-video-embed" id="embed" @if(!empty($video->type) && $video->type == 'file')style="display:none"@endif>
					...
					<div class="panel panel-primary" data-collapsed="0">
						...
						<div class="panel-body">
							...
							<div class="panel-body" id="hello">
								...
								<input type="number" step="0.01" class="form-control" name="price" id="price" min="0" value="@if(!empty($video->price)){{ $video->price }}@endif" >
							</div>
							<div class="panel-body" id="hello1">
								<p>Enter Validity &nbsp;&nbsp;&nbsp;<b>in Days</b></p>
								<input type="number" class="form-control" name="validate1" id="validate1"  value="@if(!empty($video->validate1)){{ $video->validate1 }}@endif">
								...
								<textarea class="form-control trailer_end" name="trailor_embed_code"  id="trailor_embed_code">@if(!empty($video->trailor_embed_code)){{ $video->trailor_embed_code }}@endif</textarea>
