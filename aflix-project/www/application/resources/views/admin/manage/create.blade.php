...
<!-- This is where -->
	...
	<div class="admin-section-title">
		...
		<h3><i class="entypo-plus"></i> Manage Revenue</h3> 
	
	</div>
	<div class="clear"></div>

		<form method="POST" action="/admin/manage/add_revenue" accept-charset="UTF-8" file="1" enctype="multipart/form-data">
			...
			<div class="row">
				...
				<div class="panel-body" style="display: block; padding:0px;">
					<input type="text" class="form-control" placeholder="Enter Revenue For Premium Video" name="premium_video" />
				</div> 
				...
				<div class="panel-body" style="display: block; padding:0px;">
					<input type="text" class="form-control" placeholder="Enter Revenue For Subscribe Video" name="subscribe_video" />
				</div> 
			...
			<input type="submit" value="Add Revenue" class="btn btn-success pull-right" />
