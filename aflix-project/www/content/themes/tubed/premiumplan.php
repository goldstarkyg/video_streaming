    ...
    .or {
        ...
        width: 50px;
                ...
                <div id="buyitnow_container">
                    <div class="col-md-12">
                        <div class="col-md-8" >
                            <div  class="col-md-8 tdDiv selected" id="a" style="border: solid 1px #797b74; padding: 10px; margin: 5px;">
							
                                <div><?php echo $video->title; ?></div>
                                <div class="priceDivMonthly">
                                    <label>$<?php echo $video->price; ?></label>
                                    <label class="unitMonthly ng-scope">/Prmium Video</label>
                                </div>
                                <div class="describleMonthly">Valid On : <?php echo $video->validate1; ?> Days</div>
								
                            </div>
                            
                        </div>
                        <div class="col-md-4">
                        <div class="rightCart ng-scope" ng-controller="rightCartController" id="b">
                            <style>
                                .rightCart{
                                    width: 243px;
                                    display: inline-block;
                                    ...
                                    <div ng-repeat="val in buyPlan |filterNavItems " class="orderItem ng-scope">
                                        <div class="planItem ng-scope" ng-if="val.category=='pro'||val.category=='biz'||val.category=='education'">
                                            <div ng-if="val.isYearlySelected" class="ng-scope">
                                                <label class="planTitle ng-scope" ng-if="val.category=='pro'"><?php echo $video->title; ?></label><!-- end ngIf: val.category=='pro' -->
                                                <span class="planVal ng-binding" ng-bind="val.yearly_amount*val.selectedHost/100| currency">$<?php echo $video->price; ?></span>
                                            </div>
                                    ...
                                    <div class="orderItem">
                                        <table>
                                            <tbody><tr>
                                                ...
                                                <td class="secondColumn todayTotal ng-binding" ng-bind="(todayTotalPrice()+discount)|currency">$<?php echo $video->price; ?></td>
                                            </tr>
                                            </tbody></table>
                                    </div>
...
<center><a href="<?php  echo '/user/' . @ucwords(Auth::user()->username) . '/renew_subscription?video_id='.$video->id.'&id='.$video->id.'';?>" style="float: inherit; padding: 7px;" id="button" class="btn btn-xs btn-info">Continue</a></center>
                                        </div>
                                        <p>
                                ...
                                <div style="display: none;" class="rightCartCoupon hidden-xs">
                                    <div class="coupon">
                                        <div class="coupon_code field">
                                            <label>
                                                <input type="text" title="Coupon Code" placeholder="Coupon Code" class="coupon_code form-control">
                                                <button class="check disabled">Apply </button>
                                            </label>
                                        </div>
                        ...
                        <div class="rightCart ng-scope" ng-controller="rightCartController" id="bb">
                            <style>
                                .rightCart{
                                    width: 243px;
                                    display: inline-block;
							...
							?>
                                    ...
                                    <div class="payMethod">
                                        ...
                                        <div class="accepted_cards">
                                           <img src="/content/uploads/images/PayPal.png" style="width: 85%;">
                                      <center><a href="<?php  echo '/user/' . @ucwords(Auth::user()->username) . '/renew_subscription?plan='.$plan2->id.'';?>" style="float: inherit; padding: 7px;" id="button" class="btn btn-xs btn-info">Continue</a></center>
                                        </div>
                                        <p>
                                            All amounts shown in <strong>U.S. dollars</strong>   		</p>
                    ...
                    <div class="col-md-12">
                        <div class="col-md-6">
                            ...
                            <div class="col-md-3">
                                <!--<button class="btn btn-primary btn-lg" style="padding: 8px 15px;
    margin-top: -1263%;
    background-color: #27cc95;">Continue</button>-->
...
<script>
    $(document).ready(function() {
        ...
        $('#a').click(function () {
            $(this).toggleClass('tdDiv');
            $(this).toggleClass('tdDiv selected');
            $('#aa').toggleClass('tdDiv selected');
            $('#aa').toggleClass('tdDiv');
            $('#bb').hide();
            $('#b').show();
