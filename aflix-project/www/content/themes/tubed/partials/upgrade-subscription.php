      ...
      <div class="panel panel-default registration">
        ...
        <div class="panel-heading">
          ...
          <div class="row">
              ...
              <h1 class="panel-title col-lg-8 col-md-9 col-sm-6"><?= HelloVideo\Libraries\ThemeHelper::getThemeSetting(@$theme_settings->signup_message, 'Signup to Gain access to all content on the site for $7 a month.') ?></h1>
