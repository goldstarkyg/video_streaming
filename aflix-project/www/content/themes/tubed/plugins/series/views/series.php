...
<div class="col-md-10 col-md-offset-2 right-content-10" style="padding-left:0px; padding-right:0px;">
	...
	<?php if($series->image != 'placeholder.jpg'): ?>
		<div class="sectionHeader" style="background:url(<?= HelloVideo\Libraries\ImageHandler::getImage($series->image)  ?>); background-size:cover; min-height:200px; position:relative; "></div>
	<?php else: ?>
					...
					<?php 
						...
						if($series->youtube == 1):
						  ...
						  $description = $episode->snippet->description;
							...
							$image = HelloVideo\Libraries\ImageHandler::getImage($episode->image, 'medium');
