			...
			<div class="row">
				...
				<div class="col-md-4" id="right_column" style="margin-left:0px; padding-left:0px;">
					...
					<div id="video_right" style="padding:0px;">
						...
						<?php $sidebar_videos = HelloVideo\Models\Video::where('active', '=', '1')->orderByRaw("RAND()")->take(8)->get(); ?>

							<img src="<?= HelloVideo\Libraries\ImageHandler::getImage($series->image)  ?>" style="width:100%; height:auto; max-height:60px; min-height:60px;" />
										...
										<div class="vueLoad1">
										 ...
										 <div class="content active">
										 	<a href="<?= URL::to($series_url) . '/' . $series->slug . '/episode/' . $episode->slug ?>">
									  			<img src="<?= HelloVideo\Libraries\ImageHandler::getImage($episode->image, 'small')  ?>" />
									  			<p><?= $episode->title ?></p>
									  			<div class="label" style="background:#DB1D1B; position:absolute; float:right; position:absolute; left:10px; bottom:10px;"><i class="fa fa-play"></i> playing</div>
									  			<div style="clear:both"></div>
									  		</a>
