...
<?php if(isset($video->id)): ?>
    ...
    <meta itemprop="image" content="<?= ($settings->enable_https) ? secure_url('/') : URL::to('/'); ?><?= HelloVideo\Libraries\ImageHandler::getImage($video->image, 'large')  ?>">

    <!-- for Facebook -->
    <meta property="og:title" content="<?= $video->title ?>" />
    <meta property="og:type" content="video.other" />
    <meta property="og:image" content="<?= ($settings->enable_https) ? secure_url('/') : URL::to('/'); ?><?= HelloVideo\Libraries\ImageHandler::getImage($video->image, 'large')  ?>" />
    ...
    <meta name="twitter:image" content="<?= ($settings->enable_https) ? secure_url('/') : URL::to('/'); ?><?= HelloVideo\Libraries\ImageHandler::getImage($video->image, 'large')  ?>" />
...
<?php elseif(isset($post->id)): ?>
    ...
    <meta itemprop="image" content="<?= ($settings->enable_https) ? secure_url('/') : URL::to('/'); ?><?= HelloVideo\Libraries\ImageHandler::getImage($post->image, 'large')  ?>">

    <!-- for Facebook -->
    <meta property="og:title" content="<?= $post->title ?>" />
    <meta property="og:type" content="article" />
    <meta property="og:image" content="<?= ($settings->enable_https) ? secure_url('/') : URL::to('/'); ?><?= HelloVideo\Libraries\ImageHandler::getImage($post->image, 'large')  ?>" />
    <meta property="og:url" content="<?= Request::url(); ?>" />
    ...
    <meta name="twitter:image" content="<?= ($settings->enable_https) ? secure_url('/') : URL::to('/'); ?><?= HelloVideo\Libraries\ImageHandler::getImage($post->image, 'large')  ?>" />
...
<?php if(isset($video->id) || isset($episode->id)): ?>
	...
	<script src="<?= THEME_URL . '/assets/js/E-v1.js'; ?>"></script>
    <style type="text/css">
...
<style type="text/css"><?= HelloVideo\Libraries\ThemeHelper::getThemeSetting(@$theme_settings->custom_css, '') ?></style>
